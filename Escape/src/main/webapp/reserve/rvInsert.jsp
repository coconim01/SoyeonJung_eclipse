...
<style type="text/css">
   ...
   .input-group-text, .form-control {font-family: 'Nanum Gothic', sans-serif;font-weight: Bold; /* 글꼴 */}
	.input-group, .pagination{margin: 7px;}
...
<script type="text/javascript">
		...
		$(document).ready(function(){	 
			...
			var price = '${requestScope.bean.price*2}' ;
			price.toLocaleString(); // 10,000
			
			$('#totalprice').text(price) ; /* 최초 시작시 금액 2인 기준으로 셋팅 */
...
<div class="container mt-3 col-md-5">
      <h1>테마 예약 페이지</h1>
         ...
         <div class="input-group">
            ...
            <input id="fakerevdate" name="fakerevdate" type="text" disabled="disabled"  class="form-control" placeholder="" value="${requestScope.revdate}">
            <input id="revdate" name="revdate" type="hidden" class="form-control" placeholder="" value="${requestScope.revdate}">
         </div> 
         <div class="input-group">
            <span class="input-group-text col-md-2">예약시간</span> 
            <input id="fakerevtime" name="fakerevtime" type="text" disabled="disabled"  class="form-control" placeholder="" value="${requestScope.revtime}">
            <input id="revtime" name="revtime" type="hidden" class="form-control" placeholder="" value="${requestScope.revtime}">
         </div>
         <div class="input-group">
         ...
         <div class="pagination">
            ...
            <ul class="pagination" style="margin:10px;">
               ...
               <li class="page-item"><a class="page-link" href="#">
                   <input type="text" id="people" name="people" size=2 maxlength=6 value="2">
               </a></li>
         ...
         <div id="buttonset" class="input-group">
            <button type="submit" class="btn btn-primary btn-lg" onclick="return reservCheck();"> 
               예약완료
            </button>
         </div>
      </form>
